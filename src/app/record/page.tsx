    ...
    <div className="min-h-screen bg-vt-bg flex overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative border-l border-vt-outline/50">
        ...
        >
          ...
          <p className="text-vt-muted text-sm mb-8">Choose your account to get started</p>
          ...
          <p className="text-vt-faint text-xs text-center mt-8 leading-relaxed">
            ...
            <br />Video processing happens locally in your browser.
          </p>
        </motion.div>
      </div>
    </div>
...
function SignInButton({ onClick, loading, disabled, icon, label, accent }: {
  ...
  return (
    <button onClick={onClick} disabled={disabled}
      className={`group flex items-center gap-4 w-full glass rounded-2xl px-5 h-14 transition-all duration-300 ${hoverClass} disabled:opacity-50 disabled:cursor-not-allowed`}>
